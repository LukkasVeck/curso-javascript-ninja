...
var lucas = new Person ('lucas', 'pereira', 22)
var maria = new Person ('maria', 'eduarda', 25)
var jose = new Person('jose', 'doegito', 42)
...
console.log( '\nNova idade das pessoas:' );
  ...
  console.log(jose.getFullName() + ' agora tem ' + jose.addAge(10).getAge() + 'anos')
